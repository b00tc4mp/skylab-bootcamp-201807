...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        cmd = ["python3", "-u", os.path.join(SCRIPT_DIR, "dump_checkpoints/dump_checkpoint_vars.py"), "--model_type", "tensorflow", "--output_dir", tmp_dir, "--checkpoint_file", checkpoint_file]
        sp.check_call(cmd)
