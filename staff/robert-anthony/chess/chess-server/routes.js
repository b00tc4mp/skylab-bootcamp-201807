...
router.post('/register', jsonBodyParser, (req, res) => {
  ...
  logger.info('/register', { "context": "router.js", "email": email,"password":password,"nickname":nickname })
...
router.post('/authenticate', jsonBodyParser, (req, res) => {
  ...
  logger.info('/authenticate', { "context": "router.js", "nickname": nickname,"password":password })
...
router.patch('/user/:nickname', [validateJwt, jsonBodyParser], (req, res) => {
  ...
  logger.info('/user/:nickname', { "context": "router.js", "nickname": nickname,"password":password, "newPassword":newPassword })
...
router.get('/user/:nickname/games', [validateJwt], (req, res) => {
  ...
  logger.info('/user/:nickname/games', { "context": "router.js", "nickname": nickname })
...
router.get('/user/:nickname/users', [validateJwt], (req, res) => {
  ...
  logger.info('/user/:nickname/users', { "context": "router.js", "term": term, "nickname":nickname })
...
router.patch('/user/:nickname/game/:gameID', [validateJwt], (req, res) => {
  ...
  logger.info('/user/:nickname/game/:gameID/', { "context": "router.js", "nickname":nickname, "gameID": gameID })
...
router.post('/user/:nickname/game/:gameID', [validateJwt, jsonBodyParser], (req, res) => {
  ...
  logger.info('/user/:nickname/game/:gameID/', { "context": "router.js", "nickname":nickname, "gameID": gameID, "move":JSON.stringify(move), "opponent": opponent })
...
router.post('/user/:nickname/gamerequest', [validateJwt, jsonBodyParser], (req, res) => {
  ...
  logger.info('/user/:nickname/gamerequest/', { "context": "router.js", "nickname":nickname, "opponent": opponent })
