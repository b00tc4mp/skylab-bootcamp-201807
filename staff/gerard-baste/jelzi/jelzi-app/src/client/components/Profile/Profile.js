...
class Profile extends Component {
  ...
  componentDidMount() {
    ...
    logic.retrieveProfileUser(email, token).then(userAllergens => {
  ...
  handleSubmit = event => {
    ...
    const {
      state: { allergens, newUserAllergens }
    } = this;
    ...
    logic
      .updateAllergens(email, this.oldAllergens, arrAllergens, token)
      .then(() => {
      ...
      <div className="mt-4">
        <Form id="registerForm" onSubmit={this.handleSubmit}>
          <FormGroup>
            ...
            <Label className="labelAllergens" for="exampleCheckbox">
              Your Allergens
            </Label>
            <div className="allergens">
              <div>
                <CustomInput
                  ...
                  checked={this.state.newUserAllergens["alcohol-free"]}
                  name="alcohol-free"
                ...
                <CustomInput
                  ...
                  value="celery-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["celery-free"]}
                  name="celery-free"
                ...
                <CustomInput
                  ...
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["crustacean-free"]}
                ...
                <CustomInput
                  ...
                  value="dairy-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["dairy-free"]}
                  name="dairy-free"
              ...
              <div>
                <CustomInput
                  ...
                  value="egg-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["egg-free"]}
                  name="egg-free"
                ...
                <CustomInput
                  ...
                  value="fish-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["fish-free"]}
                  name="fish-free"
                ...
                <CustomInput
                  ...
                  value="gluten-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["gluten-free"]}
                  name="gluten-free"
                ...
                <CustomInput
                  ...
                  value="mustard-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["mustard-free"]}
                  name="mustard-free"
              ...
              <div>
                <CustomInput
                  ...
                  value="No-oil-added"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["No-oil-added"]}
                  name="No-oil-added"
                ...
                <CustomInput
                  ...
                  value="low-sugar"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["low-sugar"]}
                  name="low-sugar"
                ...
                <CustomInput
                  ...
                  value="peanut-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["peanut-free"]}
                  name="peanut-free"
                ...
                <CustomInput
                  ...
                  value="pork-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["pork-free"]}
                  name="pork-free"
              ...
              <div>
                <CustomInput
                  ...
                  value="red-meat-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["red-meat-free"]}
                  name="red-meat-free"
                ...
                <CustomInput
                  ...
                  value="sesame-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["sesame-free"]}
                  name="sesame-free"
                ...
                <CustomInput
                  ...
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["shellfish-free"]}
                  name="shellfish-free"
                ...
                <CustomInput
                  ...
                  value="soy-free"
                  onChange={this.keepAllergens}
                  checked={this.state.newUserAllergens["soy-free"]}
                  name="soy-free"
