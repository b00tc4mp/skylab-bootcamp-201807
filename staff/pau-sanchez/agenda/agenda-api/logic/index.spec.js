...
describe('logic', () => {
    ...
    true && describe('add contact', () => {
        ...
        const contactEmail = 'contact@email.com', name = 'Mr. Contact', surname = 'Contacting', phone = '666'

        before(()=> User.Contact.push({ contactEmail, name, surname, phone}))
    
        it('should succed on correct data', () => 
            logic.addContact(contactEmail, name, surname, phone)
                .then(res => {
                    expect(res).to.be.true
                ...
                .then(user => {
                    ...
                    expect(contact.email).to.equal(contactEmail)
