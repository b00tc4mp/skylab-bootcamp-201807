...
function startUp() {
    document.getElementById("formNames").style.display = "block";
...
function getNames() {
    ...
    var name2ndPlayer = document.getElementById("name2ndPlayer").value;
...
function turnandplay(turn){
	if (questions1stPlayer[0].winner == true){
		document.getElementById("PinBetweenCircles").innerHTML = questions1stPlayer[0].name+" acabó!";
		...
		document.getElementById("PinBetweenCircles").innerHTML =questions2ndPlayer[0].name+" acabó!";
		...
		document.getElementById("PinBetweenCircles").innerHTML = "Turno de "+questions1stPlayer[0].name;
		askingPlayer(questions1stPlayer, true)
	} else if (turn == true && (questions1stPlayer[0].winner != true || questions2ndPlayer[0].winner == true)){
		document.getElementById("PinBetweenCircles").innerHTML = "Turno de "+questions2ndPlayer[0].name;
...
function askingPlayer(questions,turn){
	...
	document.getElementById("PinBetweenCircles").innerHTML = "Te toca "+questions[0].name+"!";	
	...
	for (var i = 1; i < questions.length; i++){
		if (questions1stPlayer[0].winner == true || questions2ndPlayer[0].winner == true){
			...
			document.getElementById("questions").innerHTML= 	<form>
																	<div>questions[0].name+"! "+questions[i].question,"Pista: "+questions[i].answer</div>;
																    <input type="text" id="questionAnswer" value="">;
																	<input type="submit" name="Continuar">;
																</form>;						

			playerAnswer = document.getElementById("questionAnswer").value;
