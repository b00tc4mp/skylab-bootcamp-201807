...
class UpdateNotebook extends Component {
    state = {
        seconds: '',
        notetitle: '',
        notetext: '',
    ...
    buildNote = e => {
        ...
        const { playedSeconds, notetitle, notetext, noteBookId} = this.state
        
        return Promise.resolve()
            .then(() => {
                return logic.createNote(playedSeconds, notetitle, notetext, noteBookId, userId, token)
            })
...
export default withRouter(UpdateNotebook)
