                            ...
                            <div>
                                ...
                                <div className="flexCat">
                                    ...
                                    <div className="cat">
                                        ...
                                        <div className="form-check form-check-inline">
                                            <input className="form-check-input" name="Parking" type="checkbox" id="inlineCheckbox4" value="option4" onChange={this.onCheckboxChanged} />
                                            <label className="form-check-label" for="inlineCheckbox4">Parking</label>
                                        </div>
                                        <div className="form-check form-check-inline">
                                            <input className="form-check-input" name="Garden" type="checkbox" id="inlineCheckbox5" value="option5" onChange={this.onCheckboxChanged} />
