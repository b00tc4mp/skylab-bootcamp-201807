...
var acertados = 0;
var fallados = 0;
var acertado = document.getElementById("showOk");
var fallado = document.getElementById("showBad");
var userAnswer;

function showQuestion(){
	userAnswer = document.getElementById("questions");
	userAnswer.innerHTML = questions[index].question;
}

function checkAnswer(){
	userAnswer = document.getElementById("answer").value.toLowerCase();
	if(userAnswer === questions[index].answer){
		alert("Que bien! Has acertado!");
		questions[index].status = 1;
		acertados++;
		acertado.innerHTML = acertados;
	}else if(userAnswer != questions[index].answer){
		alert("Oooh! Lo siento, has fallado!");
		questions[index].status = 2;
		fallados++;
		fallado.innerHTML = fallados;
	}else{
		showQuestion();
	}
	index++;
...
function pasaPalabra(){
	var pasar = questions.splice(index, 1)[0];
	questions.push(pasar);
	showQuestion();
} 
