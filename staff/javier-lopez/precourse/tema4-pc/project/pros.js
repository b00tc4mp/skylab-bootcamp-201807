...
function pasapalabra(question){
    ...
    function askTurn(){
        ...
        if(initiate == true){
            ...
            var initiate = confirm("Instrucciones: Irán apareciendo las descripciones de las palabras que empiecen por la letra en la que estés. Si te encayas en una letra, puedes guardarla para mas tarde escribiendo pasapalabra.");
