...
class Agenda extends Component {
    ...
    onDelete = e => {
        ...
        const id = e.target.dataset.idnote
                    ...
                    (!!notes.length) && <ul>
                        {
                            notes.map(note =>{
                                ...
                                return (<div key={note._id}>
                                    ...
                                    <div>
                                        <button data-idnote={note._id} onClick={this.onDelete}>[x]</button>
                                        <button data-idnote={note._id} onClick={this.onUpdate}>Edit</button>
                                    </div>
                                </div>)
                            }
