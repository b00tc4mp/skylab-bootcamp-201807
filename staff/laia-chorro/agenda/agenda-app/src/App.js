  ...
  render() {
    ...
    return <div className="full-height">
      ...
      <Switch>
        ...
        <Route path="/login" render={() => this.isLoggedIn() ? <Redirect to="/agenda" /> : <Login onLoggedIn={this.onLoggedIn} />} />
        <Route path="/agenda" render={() => this.isLoggedIn() ? <Agenda username={username} token={token} onLogout={this.onLogout} /> : <Redirect to="/" />} />
      </Switch>
