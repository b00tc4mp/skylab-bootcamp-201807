    ...
    render(){
        return <div>
            ...
            <form onSubmit={this.handleSubmit}>
                <input type="text" name="filterName" placeholder="Filter" value={this.state.filterName} onChange={this.handleChange}/>
            ...
            <ul>
                {this.state.contacts.map(contact => {
                    if(contact.name.toLowerCase().includes(this.state.filterName.toLowerCase())){
                        ...
                        <li key={contact.id}> {`name:${contact.name},surname:${contact.surname},phone:${contact.phone},contactmail:${contact.contactmail},address:${contact.address}`} <a href="" onClick={(e) =>  {e.preventDefault();this.deleteContact(contact.id)}} >X</a> <a href="" onClick={(e) => this.editContact(e,contact)}>EDIT ME </a> </li>
                    }
                })}
            </ul>
        </div>
