...
describe('logic (spotify-app)', () => {
    describe('user\'s', () => {
        ...
        describe('register user', () => {
            const username = 'edu-berenguer' + Math.random(), password = '123'
        ...
        describe('update user', () => {
            const username = 'edu-berenguer' + Math.random(), password = '123', newPassword = '456', newUsername = 'edu-berenguer' + Math.random()
