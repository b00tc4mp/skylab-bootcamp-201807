...
describe("register of the user", () => {
    ...
    const username = "pepe-" + Math.random(),
        password = "123"
...
describe('CRUD for Api\'s Nutrition', () => {
    ...
    describe('Look up the nutrition information for any branded food item', () => {
        ...
        const id = '599e7ab83f4a58a961487b4c'

        it("should show ingredient info", () => {

            return logic.ingredientInfo(id)
                .then(result => {
                    expect(result).toBeTruthy()
                    expect(result.foods[0].food_name).toBe("Pecan Clusters, Milk Chocolate Caramel")
